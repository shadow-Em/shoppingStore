...
/**
 * Servlet implementation class AddNewGoods2
 */
@WebServlet(name = "add-new-goods2", urlPatterns = { "/add-new-goods2" })
public class AddNewGoods2 extends HttpServlet {
