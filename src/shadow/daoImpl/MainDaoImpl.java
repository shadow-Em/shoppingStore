...
public class MainDaoImpl implements MainDao {
	...
	@Override
	public void logout(String uId) throws SQLException {
	...
	@Override
	public List<LogInfo> loadLogInfo() throws SQLException{
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		ResultSet rs =null;
		List<LogInfo> l=null;
		try {
			String sql="select uId,lTime,lType from `log` order by lTime DESC;";
			ps=conn.prepareStatement(sql);
			rs=ps.executeQuery();
			l=new BeanListHandler<LogInfo>(LogInfo.class).handle(rs);
			for(LogInfo i:l) {
				if(i.getlType()==1) {
					i.setuDo("用户登录");
				}
				else if(i.getlType()==2) {
					i.setuDo("用户退出登录");
				}
			}
		} catch (Exception e) {
	...
	@Override
	public List<Goods> loadGoods2() throws SQLException {
		// TODO Auto-generated method stub
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		ResultSet rs =null;
		List<Goods> l = null;
		try {
			String sql="select * from goods where gReserve >=0 and gType=1;";
			ps=conn.prepareStatement(sql);
			rs = ps.executeQuery();
			l = new BeanListHandler<Goods>(Goods.class).handle(rs);
		} catch (Exception e) {
	...
	@Override
	public List<Goods> loadGoods3() throws SQLException {
		// TODO Auto-generated method stub
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		ResultSet rs =null;
		List<Goods> l = null;
		try {
			String sql="select * from goods where gReserve >=0 and gType=2;";
			ps=conn.prepareStatement(sql);
			rs = ps.executeQuery();
			l = new BeanListHandler<Goods>(Goods.class).handle(rs);
		} catch (Exception e) {
	...
	@Override
	public List<Seller> getSellerInfo() throws SQLException{
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;
		ResultSet rs=null;
		List<Seller> s=new ArrayList<Seller>();
		String sql="select uId,uName,uPost,uMoney from user where uId='admin' or uId='admin2';";
		try {
			ps=conn.prepareStatement(sql);
			rs=ps.executeQuery();
			s=new BeanListHandler<Seller>(Seller.class).handle(rs);
		} catch (Exception e) {
			// TODO: handle exception
		}
		return s;
...
//		String rNo = UUID.randomUUID().toString();
	...
	public List<BrowsedCard> loadBrowsed(String uNo) throws SQLException {
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		String sql="SELECT  r.rTime rTime, g.* FROM record r LEFT JOIN goods g ON r.gNo = g.gNo WHERE r.uNo = ? AND r.rType = 1 order by rTime DESC;";
		ResultSet rs = null;
	...
	@Override
	public List<BroughtGoods> loadBroughtGoods2() throws SQLException {
		// TODO Auto-generated method stub
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		List<BroughtGoods> l = null;
		ResultSet rs=null;
		try {
			String sql="call loadBroughtGoods2();";
			ps=conn.prepareStatement(sql);
			rs = ps.executeQuery();
			l = new BeanListHandler<BroughtGoods>(BroughtGoods.class).handle(rs);
			for(BroughtGoods i : l) {
	...
	@Override
	public List<BroughtGoods> loadAllBrought() throws SQLException {
		// TODO Auto-generated method stub
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		List<BroughtGoods> l = null;
		ResultSet rs=null;
		try {
			String sql="call loadAllBrought();";
			ps=conn.prepareStatement(sql);
			rs = ps.executeQuery();
			l = new BeanListHandler<BroughtGoods>(BroughtGoods.class).handle(rs);
			for(BroughtGoods i : l) {
				if(i.getgReserve()==-1)
					...
					i.setgStatus("商品库存充足");
				i.setgAllMoney(i.getgAllMoney()+i.getgNum()*i.getgMoney());
			}
			System.out.println(l);
		} catch (Exception e) {
			// TODO Auto-generated catch block
	...
	@Override
	public List<CustomerInfo> loadCustomerInfo2() throws SQLException{
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		List<CustomerInfo> l=null;
		ResultSet rs = null;
		try {
			String sql="call loadCustomerInfo2();";
			ps=conn.prepareStatement(sql);
			rs = ps.executeQuery();
			l = new BeanListHandler<CustomerInfo>(CustomerInfo.class).handle(rs);	
			for(CustomerInfo i : l) {
	...
	@Override
	public List<SellerInfo> loadSellerInfo() throws SQLException{
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		List<SellerInfo> l=null;
		ResultSet rs = null;
		try {
			String sql="call loadSellerInfo();";
			ps=conn.prepareStatement(sql);
			rs = ps.executeQuery();
			l = new BeanListHandler<SellerInfo>(SellerInfo.class).handle(rs);	
			for(SellerInfo i : l) {
				if(i.getrType()==4)
					i.setuDo("添加商品");
				else if(i.getrType()==5)
					i.setuDo("删除商品");
				else if(i.getrType()==6)
					i.setuDo("修改商品信息");
			}
		}catch (Exception e) {
			// TODO: handle exception
	...
	@Override
	public List<SellerInfo> loadSellerInfo2() throws SQLException{
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		List<SellerInfo> l=null;
		ResultSet rs = null;
		try {
			String sql="call loadSellerInfo2();";
			ps=conn.prepareStatement(sql);
			rs = ps.executeQuery();
			l = new BeanListHandler<SellerInfo>(SellerInfo.class).handle(rs);	
			for(SellerInfo i : l) {
	...
	@Override
	public void deleteGoods(String gNo,String uNo) throws SQLException {
		// TODO Auto-generated method stub
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		try {
	...
	@Override
	public void addNewGoods(Goods g,String uNo) throws SQLException {
		// TODO Auto-generated method stub
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		String sql="";	
	...
	@Override
	public void addNewGoods2(Goods g,String uNo) throws SQLException {
		// TODO Auto-generated method stub
		Connection conn=DBCP.ds.getConnection();
		PreparedStatement ps=null;	
		String sql="";	
